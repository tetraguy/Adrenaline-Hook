...
Adrenaline Hook is a utility developed to seamlessly integrate UWP, and GamePass/Xbox PC titles into AMD Adrenalin Software. Due to Microsoft’s DRM restrictions, manually adding GamePass executables to Adrenalin is typically not possible without complex and temporary workarounds that often break after game updates.
